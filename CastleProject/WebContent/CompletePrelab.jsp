             ...
             <c:set var="netid" value="<%=netid%>"/>
                ...
                <div align="left">
                 ...
                 <c:forEach var="stud" items="${listMenu.rows}">
                     ...
                     <tr>     
                           <h3>Congratulations <%=username %>, you have completed the Pre-Lab 
                           for Experiment</h3>
                           <c:out value="${stud.expname}" />
                           
                           <h4>
                           Select a section Which section would you like to start with?<br><br>
        Part 1:<a href="Actexpone.jsp?name=${stud.expname}">Volumetric Glassware</a><br><br>
        Part 2: <a href="Actexptwo.jsp?name=${stud.expname}">Acid-Base Titration</a><br><br>
                         </h4>
