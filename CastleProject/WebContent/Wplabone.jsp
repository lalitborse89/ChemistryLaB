...
<h2>Written Pre-Lab -Section ONE</h2>
       ...
       -->       
          ...
          <div id="tabss-7">
            ...
            <div id="register">
               ...
               <form action="WplaboneCon" method="post"> 
        ...
        <div id="tabss-3">
          ...
          <p class="submit">
            ...
            <div id="register">
                ...
                <div align="left">
              <textarea  name="variables" placeholder="Variables" rows="4" cols="50">
