...
<link rel="stylesheet" type="text/css" href="css/style.css" />
    ...
    <body onload ="loadPage()">
     <%
    Dao dk = new Dao();
    PriorityQueue<Question> pp=dk.QchcekBox(3);
    int noofQ=pp.size();
...
<div class="container">
  ...
  <div id="q6">
        <form action="CompassemtCon" method="post">
        Assessment Section Completed
          <button type="submit" id="num" value=1>Proceed</button>
          <%--  <a href="Preasgmtfour.jsp?num=${stud.expno}">Go_For_Next</a> --%>
           </form> 
