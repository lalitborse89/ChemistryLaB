 ...
 %>
	<div id="ldiv">
		<%
            ...
            out.print("<tr><th>Trial</th><th>Initial Mass(g)</th><th>Final Mass(g)</th></tr>");
 ...
 */		%>
	...
	<script>
function loadPage(){
	firstcurrQ = localStorage.getItem("firstcurrQ");    
    console.log("*********************************Attempone*********************************"+firstcurrQ)    
  window.location.href="Actexpone.jsp?json="+firstcurrQ;
